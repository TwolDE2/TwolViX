...
#			STARTUP_7 = "kernel=/linuxrootfs7/zImage root=/dev/%s rootsubdir=linuxrootfs7" % hdd[0] 	# /STARTUP_7
		STARTUP_4 = 'kernel=/linuxrootfs4/STARTUP_4.kernel root="%s" rootsubdir=linuxrootfs4' % self.device_uuid 	# /STARTUP_4
		STARTUP_5 = 'kernel=/linuxrootfs5/STARTUP_5.kernel root="%s" rootsubdir=linuxrootfs5' % self.device_uuid 	# /STARTUP_5
		STARTUP_6 = 'kernel=/linuxrootfs6/STARTUP_6.kernel root="%s" rootsubdir=linuxrootfs6' % self.device_uuid 	# /STARTUP_6
		STARTUP_7 = 'kernel=/linuxrootfs7/STARTUP_7.kernel root="%s" rootsubdir=linuxrootfs7' % self.device_uuid 	# /STARTUP_7
