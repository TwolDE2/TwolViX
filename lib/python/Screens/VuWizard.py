...
class VuWizard(Screen):
	...
	<screen name="VuWizard" position="center,center" size="750,700" flags="wfNoBorder" backgroundColor="transparent">
		...
		<widget source="description" render="Label" position="2,80" size="730,200" halign="center" font="Regular; 22" backgroundColor="#00000000" foregroundColor="#00ffffff" />
	...
	def __init__(self, session):
		...
		self["description"] = Label(_("Enabling MultiBoot - restoring slots can take upto 5 minutes per image.\n Receiver will reboot to setup Wizard after completion.\n After Wizard, flash image with ImaegManager or use MultiBootSelector "))
