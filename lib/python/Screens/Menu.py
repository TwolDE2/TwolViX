...
# read the menu... recovery.xml is an abreviated version of menu.xml used for Vu+ slot 0 (recovery image).
file = open(resolveFilename(SCOPE_SKINS, 'recovery.xml' if SystemInfo["HasKexecMultiboot"] and SystemInfo["MultiBootSlot"] == 0 else 'menu.xml'), 'r')
