...
class ServiceInfoEXET8500blue(Poll, Converter, object):
	apid = 0
	vpid = 1
	sid = 2
	onid = 3
	...
	def getText(self):
		...
		self.stream['vtype'] = ("MP3", "MPEG2", "MPEG4", "MPEG1", "MPEG4-II", "VC1", "VC1-SM", "")[info.getInfo(iServiceInformation.sVideoType)]
		self.stream['avtype'] = ("MP3", "MPEG2/", "MPEG4/", "MPEG1/", "MPEG4-II/", "VC1/", "VC1-SM/", "")[info.getInfo(iServiceInformation.sVideoType)] + self.stream['atype']
		...
		if self.type == self.HAS_TELETEXT:
			...
			if audio:
				...
				while idx < n:
					...
					if "AC3" in description or "AC-3" in description or "DTS" in description  or "MP3" in description or "MPEG" in description:
						return True
					idx += 1
			return False
