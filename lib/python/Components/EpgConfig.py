...
from Components.config import config, ConfigClock, ConfigClockDefault, ConfigSelection, ConfigSelectionNumber, ConfigSubsection, ConfigYesNo, NoSave
...
def InitEPGConfig():
	...
	config.epgselection.infobar.primetime = ConfigClock(default = ConfigClockDefault(hours=20, minutes=0))
	...
	config.epgselection.grid.primetime = ConfigClock(default = ConfigClockDefault(hours=20, minutes=0))
