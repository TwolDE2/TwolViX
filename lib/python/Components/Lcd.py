...
def InitLcd():
	...
	if SystemInfo["Display"]:
		...
		if SystemInfo["LCDMiniTV"] and SystemInfo["boxtype"] not in ("gbquad4k", "gbue4k", "gbquad4kpro"):
		...
		elif can_lcdmodechecking and SystemInfo["boxtype"] in ("gbquad4k", "gbue4k", "gbquad4kpro"):
