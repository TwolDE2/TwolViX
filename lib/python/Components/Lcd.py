...
def InitLcd():
	if getBoxType() in ('wetekplay', 'wetekplayplus', 'gb800se', 'gb800solo', 'iqonios300hd', 'tmsingle', 'tmnano2super', 'tmnanosecombo', 'vusolo', 'vusolose', 'vuzero', 'et4x00', 'et5x00', 'et6x00', 'sf8'):
		detected = False
	else:
