...
def InitUsageConfig():
	...
	config.epgselection.grid.btn_red = ConfigSelection(default='24minus', choices=[
	...
	config.epgselection.grid.btn_green = ConfigSelection(default='timer', choices=[
		('autotimer', _('Auto Timer')),
	 	('timer', _('Add/Remove Timer')),
	 	('24plus', _('24+ Hours')),
	 	('24minus', _('24- Hours')),
	...
	config.epgselection.grid.btn_yellow = ConfigSelection(default='24plus', choices=[
		('autotimer', _('Auto Timer')),
	 	('timer', _('Add/Remove Timer')),
	 	('24plus', _('24+ Hours')),
	 	('24minus', _('24- Hours')),
	...
	config.epgselection.grid.btn_blue = ConfigSelection(default='autotimer', choices=[
		('autotimer', _('Auto Timer')),
		('timer', _('Add/Remove Timer')),
		('24plus', _('24+ Hours')),
		('24minus', _('24- Hours')),
