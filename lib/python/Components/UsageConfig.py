...
#GML:2
	...
	def setDateStyles(configElement):
		...
		config.usage.date.compact_template.value = style[8]
		config.usage.date.compact_template.save()
		adjustCompactDate()
	...
	(displayEnabled) = skin.parameters.get("AllowUserDatesAndTimesDisplay", (0))
	if displayEnabled:
	...
	config.epgselection.graph_green = ConfigSelection(default='timer', choices=[
		('autotimer', _('Auto Timer')),
	 	('timer', _('Add/Remove Timer')),
	 	('24plus', _('24+ Hours')),
	 	('24minus', _('24- Hours')),
	...
	config.epgselection.graph_blue = ConfigSelection(default='autotimer', choices=[
		('autotimer', _('Auto Timer')),
		('timer', _('Add/Remove Timer')),
		('24plus', _('24+ Hours')),
		('24minus', _('24- Hours')),
