...
class AVSwitch:
	...
	if about.getChipSetString() in ('5272s', '7251', '7251S', '7251s' '7252', '7252s', '7366', '7376', '7445s'):
		modes["HDMI"] = ["1080p", "2160p", "2160p30", "1080i", "720p", "576p", "576i", "480p", "480i"]
		widescreen_modes = {"1080p", "2160p", "2160p30", "1080i", "720p"}
	...
	if modes.has_key("Scart") and getBoxType() in ('gb800ueplus','gbultraue','mbmicro','mbtwinplus','mutant500c','osmega','osmini','osminiplus','sf138','sf4008', 'tmnano','tmnanose','tmnanosecombo','tmnanoseplus','tmnanosem2','tmnanosem2plus','tmnano2super','tmnano3t','xpeedlx3'):
		modes["RCA"] = modes["Scart"]
		del modes["Scart"]
		
	# Machines that have neither RCA nor Scart sockets 
	if modes.has_key("Scart") and getBoxType() in ('wetekplay', 'wetekplayplus',
'et5x00','et6x00','gbquad','gbx1','gbx3','ixussone','sf4008','tmnano2t','vusolo4k','vuuno4k','vuultimo4k','mutant51','mutant1500','wetekplay', 'wetekplayplus'):
		del modes["Scart"]
