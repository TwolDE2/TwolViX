...
class AVSwitch:
	...
	if modes.has_key("Scart") and getBoxType() in ('gb800ueplus','gbultraue','mbmicro','mbtwinplus','mutant500c','osmini','osminiplus','sf138','tmnano','tmnanose','tmnanosecombo','tmnanoseplus','tmnanosem2','tmnanosem2plus','tmnano2super','tmnano3t','xpeedlx3'):
		modes["RCA"] = modes["Scart"]
		del modes["Scart"]
		
	# Machines that have neither RCA nor Scart sockets 
	if modes.has_key("Scart") and getBoxType() in ('et5x00','et6x00','gbquad','gbx1','gbx3','ixussone','tmnano2t','vusolo4k','mutant51','mutant1500','wetekplay', 'wetekplayplus'):
		del modes["Scart"]
