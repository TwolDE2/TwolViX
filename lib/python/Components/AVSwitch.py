...
class AVSwitch:
	...
	if modes.has_key("YPbPr") and getBoxType() in ('wetekplay', 'wetekplayplus',  'dm500hdv2','dm500hd','dm800','e3hd','ebox7358','eboxlumi','ebox5100','enfinity','et4x00','iqonios300hd','ixusszero','mbmicro','mbtwinplus','mutant51','mutant500c','mutant1200','mutant1500','odimm7','optimussos1','osmini','osminiplus','tm2t','tmnano','tmnano2super','tmnano3t','tmnanose','tmnanosecombo','tmnanoseplus','tmnanosem2','tmnanosem2plus','tmsingle','optimussos1','uniboxhd1','vusolo2','vusolo4k','xp1000'):
		del modes["YPbPr"]
		
	# Machines that have composite video (yellow RCA socket) but do not have Scart.
	if modes.has_key("Scart") and getBoxType() in ('gb800ueplus','mbmicro','mbtwinplus','mutant500c','osmini','osminiplus','tmnano','tmnanose','tmnanosecombo','tmnanoseplus','tmnanosem2','tmnanosem2plus','tmnano2super','tmnano3t','xpeedlx3'):
		modes["RCA"] = modes["Scart"]
		del modes["Scart"]
		
	# Machines that have neither RCA nor Scart sockets 
	if modes.has_key("Scart") and getBoxType() in ('wetekplay', 'wetekplayplus', 'et5x00','et6x00','gbquad','ixussone','tmnano2t','tmnanose','vusolo4k','mutant51','mutant1500'):
		del modes["Scart"]
