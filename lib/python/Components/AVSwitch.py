...
class AVSwitch:
	...
	if about.getChipSetString() in ('5272s', '7251S', '7252', '7252s', '7366', '7376', '7445s'):
	...
	if modes.has_key("Scart") and getBoxType() in ('et5x00','et6x00','gbquad','gbx1','gbx3','ixussone','tmnano2t','vusolo4k','vuuno4k','vuultimo4k','mutant51','mutant1500','wetekplay', 'wetekplayplus'):
		del modes["Scart"]
