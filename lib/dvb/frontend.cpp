...
void eDVBFrontend::calculateSignalQuality(int snr, int &signalquality, int &signalqualitydb)
{
	...
	else if (!strcmp(m_description, "BCM7356 DVB-S2 NIM (internal)") || !strcmp(m_description, "BCM7346 DVB-S2 NIM (internal)") || !strcmp(m_description, "BCM7358 DVB-S2 NIM (internal)") || !strcmp(m_description, "BCM7362 DVB-S2 NIM (internal)") || !strcmp(m_description, "GIGA DVB-S2 NIM (Internal)") || !strcmp(m_description, "GIGA DVB-S2 NIM (SP2246T)") || !strcmp(m_description, "GIGA DVB-S2 NIM (TS2M08)"))
	{
	...
	else if (!strcmp(m_description, "DVB-S2 NIM(45208 FBC)") || !strstr(m_description, "DVB-S2 NIM(45308 FBC)")
	{
